<div id="modalMovimiento" class="fixed inset-0 z-50 hidden flex items-center justify-center bg-black/50 backdrop-blur-sm p-3 sm:p-4 transition-all duration-300">
    ...
    <div class="bg-[var(--card-color)] border border-zinc-200/60 dark:border-zinc-800/60 w-full max-w-md rounded-[1.5rem] sm:rounded-[2.5rem] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] dark:shadow-[0_0_50px_rgba(0,0,0,0.5)] overflow-hidden transform transition-all duration-500 scale-95 opacity-0 modo-crema:bg-white flex flex-col max-h-[95dvh] sm:max-h-[92dvh]" id="movimientoContainer">
        ...
        <div class="p-5 sm:p-8 pb-4 sm:pb-5 flex justify-between items-center border-b border-zinc-100 dark:border-zinc-900/50 modo-crema:border-zinc-100 shrink-0 gap-3">
        ...
        <form action="{{ route('admin.inventario.movimiento') }}" method="POST" class="flex flex-col flex-1 min-h-0">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <select name="tipo" required
                            class="w-full h-11 sm:h-12 bg-zinc-50 dark:bg-zinc-900/50 border border-zinc-200/60 dark:border-zinc-800/60 rounded-xl sm:rounded-2xl px-4 sm:px-5 text-base sm:text-xs font-bold text-[var(--text-color)] dark:text-zinc-100 focus:bg-white dark:focus:bg-zinc-900 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all appearance-none cursor-pointer">
            ...
            <div class="flex items-center gap-3 sm:gap-4 px-5 sm:px-8 py-4 border-t border-zinc-100 dark:border-zinc-900/50 modo-crema:border-zinc-100 shrink-0" style="padding-bottom: max(1rem, env(safe-area-inset-bottom));">
