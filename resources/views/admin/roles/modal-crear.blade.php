...
<div id="modalCrearRol" class="fixed inset-0 z-[100] hidden items-center justify-center p-4 bg-black/60 backdrop-blur-sm transition-all duration-300">
...
<script>
    // Se definen en window para asegurar disponibilidad global
    window.abrirModalCrear = function() {
        ...
        // Pequeño delay para permitir que el display:flex se aplique antes de la transición
