<div id="modalCrear" class="hidden fixed inset-0 z-50 items-center justify-center bg-black/60 backdrop-blur-sm">
    <div id="createContainer" class="relative bg-[#1c1c1e] rounded-2xl w-full max-w-md mx-4 shadow-2xl scale-95 opacity-0 transition-all duration-200">
        ...
        <div class="flex items-center gap-4 p-7 pb-5">
            ...
            <div>
                ...
                <p class="text-xs text-white/30 uppercase tracking-widest mt-0.5">Agregar al menú</p>
            </div>
