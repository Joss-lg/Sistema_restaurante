...
<div id="modal-crear-alimento" class="fixed inset-0 z-[100] overflow-y-auto hidden opacity-0 transition-all duration-300 backdrop-blur-sm">
    <div class="fixed inset-0 bg-black/80" onclick="closeModalCrear()"></div>
    <div class="flex min-h-screen items-center justify-center p-4">
        <div class="relative glass-card bg-[var(--card-color)] border border-[var(--border-color)] w-full max-w-2xl rounded-[2.5rem] shadow-2xl transform opacity-0 translate-y-8 transition-all duration-300" id="modal-crear-panel">
            <div class="p-10">
                <div class="flex justify-between items-start mb-8">
                    ...
                    <button onclick="closeModalCrear()" class="text-gray-500 hover:text-white transition"><i class="fas fa-times text-2xl"></i></button>
                </div>

                <form id="formulario-crear-alimento" onsubmit="guardarAlimento(event)">
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div class="col-span-2">
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                ...
                                <button type="button" onclick="agregarIngrediente('crear')" class="inline-flex items-center gap-2 self-start bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 rounded-2xl font-black transition shadow-sm"><i class="fas fa-plus"></i> Agregar ingrediente</button>
                            </div>

                            <div id="ingredientes-container-crear" class="space-y-4 mt-4"></div>
                        </div>
                    ...
                    <div class="mt-10 flex gap-4">
                        ...
                        <button type="button" onclick="closeModalCrear()" class="flex-1 bg-gray-800 hover:bg-gray-700 text-gray-400 font-black py-4 rounded-2xl transition">CANCELAR</button>
                    </div>
                </form>
            </div>
        </div>
