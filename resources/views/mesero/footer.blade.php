<footer class="h-[90px] flex-none border-t border-[var(--border-color)] glass-panel flex items-center justify-center relative z-30 transition-colors duration-400">
    ...
    <div class="flex w-full max-w-3xl justify-between px-10">
        ...
        <div class="flex flex-col items-center justify-center w-32 group cursor-default">
            <span class="text-3xl font-black text-[#3B82F6] tracking-tighter group-hover:scale-110 transition-transform drop-shadow-[0_0_12px_rgba(59,130,246,0.3)]">0</span>
        ...
        {{-- Stat 3 --}}
        <div class="flex flex-col items-center justify-center w-32 group cursor-default">
            <span class="text-3xl font-black text-amber-500 tracking-tighter group-hover:scale-110 transition-transform drop-shadow-[0_0_12px_rgba(245,158,11,0.3)]">0</span>
            <span class="text-[9px] font-black text-[var(--text-muted)] uppercase tracking-[0.2em] mt-2">Platillos</span>
        </div>
